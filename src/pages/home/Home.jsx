  ...
  return (
    <div>
      ...
      <section className="how">
        ...
        >
          <path
            d="M12 0.75L42 23.4471L72 0.75L84 5.28943L42 37.0654L0 5.28943L12 0.75Z"
            fill="#F8F8F8"
          />
        </svg>
        <h4 className="how__subtitle">
          MentorMe works with the best coaches and instructors available
        </h4>
          ...
          <div className="how__item">
            ...
            >
              <g filter="url(#filter0_i_534_2067)">
                <path
                  d="M98.4811 15.8455L52.3177 0.713862C51.7607 0.530923 51.0135 0.439453 50.2663 0.439453C49.5191 0.439453 48.7719 0.530923 48.2149 0.713862L2.05141 15.8455C0.923813 16.2114 0 17.4659 0 18.6158V81.6514C0 82.8013 0.774373 84.3171 1.71177 85.0358L48.5409 120.134C49.0164 120.487 49.6278 120.67 50.2527 120.67C50.8776 120.67 51.5025 120.487 51.9645 120.134L98.7936 85.0358C99.731 84.3301 100.505 82.8144 100.505 81.6514V18.6158C100.533 17.4659 99.6087 16.2245 98.4811 15.8455ZM90.751 79.1425L50.2663 109.484L9.78154 79.1425V23.2677L50.2663 9.99149L90.751 23.2677V79.1425Z"
                  fill="#009F3D"
                />
                <path
                  d="M9.78149 23.2679V79.1427L50.2662 109.484L90.7509 79.1427V23.2679L50.2662 9.9917L9.78149 23.2679ZM66.6775 36.5048H74.1767C75.0597 36.5048 75.576 37.4718 75.0597 38.1643L46.177 76.4117C45.9739 76.679 45.7082 76.8964 45.4013 77.0463C45.0944 77.1963 44.7551 77.2744 44.4109 77.2744C44.0667 77.2744 43.7274 77.1963 43.4205 77.0463C43.1136 76.8964 42.8478 76.679 42.6448 76.4117L25.4727 53.6749C24.9565 52.9824 25.4727 52.0154 26.3558 52.0154H33.855C34.5614 52.0154 35.2135 52.3421 35.6211 52.8779L44.4109 64.5206L64.9114 37.3672C65.3189 36.8315 65.9846 36.5048 66.6775 36.5048Z"
                  fill="#009F3D"
                  fill-opacity="0.28"
                />
                <path
                  d="M35.6212 52.8774C35.2136 52.3417 34.5615 52.015 33.8551 52.015H26.3559C25.4728 52.015 24.9566 52.982 25.4728 53.6745L42.6449 76.4113C42.8479 76.6786 43.1137 76.896 43.4206 77.0459C43.7275 77.1958 44.0668 77.274 44.411 77.274C44.7552 77.274 45.0945 77.1958 45.4014 77.0459C45.7083 76.896 45.9741 76.6786 46.1771 76.4113L75.0598 38.1639C75.5761 37.4714 75.0598 36.5044 74.1768 36.5044H66.6776C65.9847 36.5044 65.3191 36.8311 64.9115 37.3668L44.411 64.5202L35.6212 52.8774Z"
                  fill="#009F3D"
                />
              </g>
              <defs>
                <filter
                  id="filter0_i_534_2067"
                  x="0"
                  y="0.439453"
                  width="100.506"
                  height="124.23"
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="shape"
                    result="effect1_innerShadow_534_2067"
                  />
                </filter>
              </defs>
            </svg>
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_543_1100"
                  />
                  <feColorMatrix
                    in="SourceAlpha"
                    type="matrix"
                  ...
                  <feBlend
                    mode="normal"
                    in2="effect1_dropShadow_543_1100"
                    result="effect2_dropShadow_543_1100"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect2_dropShadow_543_1100"
                    result="shape"
                  />
                </filter>
                <filter
                  id="filter1_dd_543_1100"
                  x="45.1909"
                  y="14.3237"
                  width="38.1392"
                  height="40.7588"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="shape"
                    result="effect1_innerShadow_534_2064"
                  />
                </filter>
              </defs>
            </svg>
      ...
      <section className="steps">
        ...
        <div className="steps__item">
          ...
          <p className="steps__description">
            Chat via email or phone to discuss your requirements
          </p>
        </div>
